...
type VerifyTokenReq struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // 字段编号从1开始
}
...
type VerifyResp struct {
	...
	Res bool `protobuf:"varint,1,opt,name=res,proto3" json:"res,omitempty"` // 字段编号从1开始
}
...
var file_auth_proto_rawDesc = []byte{
	...
	0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x1b, 0x5a, 0x19,
	0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x6d, 0x61, 0x6c, 0x6c, 0x2f, 0x6b, 0x69, 0x74, 0x65, 0x78,
